...
public class DBHelper  extends SQLiteOpenHelper {
    ...
    public List<FavoriteList> getFavList(){
        String selectQuery = "SELECT  * FROM " + Prekes.TABLE;
        SQLiteDatabase db = this.getWritableDatabase();
        ...
        if (cursor.moveToFirst()) {
            do {
               FavoriteList list = new FavoriteList();
                ...
                list.setPavadinimas(cursor.getString(cursor.getColumnIndex("pavadinimas")));
                list.setRusis(cursor.getString(cursor.getColumnIndex("rusis")));
                list.setBePVM(cursor.getString(cursor.getColumnIndex("bpvm")));
                list.setKaina(cursor.getString(cursor.getColumnIndex("kaina")));
                FavList.add(list);
            } while (cursor.moveToNext());
        }
        //Last value show on top
